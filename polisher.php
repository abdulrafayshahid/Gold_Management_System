            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data[0] == "success") {
                        Swal.fire({
                            title: 'Deleted!',
                            text: 'Polisher Deleted Successfully',
                            icon: 'success',
                            confirmButtonText: 'Ok'
                        }).then((result) => {
                            if (result.isConfirmed) {
                                window.location.href = "polisher.php";
                            }
                        })
                    } else {
                        Swal.fire({
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (data[0] == "success") {
                            Swal.fire({
                                title: 'Success!',
                                text: 'Polisher Updated Successfully',
                                icon: 'success',
                                confirmButtonText: 'Ok'
                            }).then((result) => {
                                if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (data[0] == "success") {
                            Swal.fire({
                                title: 'Success!',
                                text: 'Polisher Added Successfully',
                                icon: 'success',
                                confirmButtonText: 'Ok'
                            }).then((result) => {
                                if (result.isConfirmed) {
